            ...
            <div className='flex flex-row max-[1180px]:flex-col justify-between items-center px-[120px] w-[90%] h-auto rounded-3xl bgSale'>
                <div className="w-[600px] max-[850px]:w-[250px] max-[850px]:mt-[10px] object-contain">
                    <Image
                        ...
                        data-aos='fade-in' aos-delay='3000'
                    />
                </div>
                <div className='flex flex-col gap-[20px] max-[1180px]:items-center max-[1180px]:mt-[30px] max-[1180px]:text-center'>
                    ...
                    <p data-aos='fade-right' className='pl-[20px] max-[1180px]:pl-[0px] max-[1180px]:text-center max-[1180px]:w-[100%] saleP'>Spend minimal $100 get 30% off <br />
                    voucher code for your next purchase</p>
                    <p data-aos='fade-left' className='max-[1180px]:text-center font-sans font-semibold pl-[20px] max-[360px]:pl-[0px]'>1 June - 10 June 2021 <p className='text-[15px] font-thin'>*Terms & Conditions apply</p></p>
