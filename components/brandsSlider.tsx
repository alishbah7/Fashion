    ...
    return(
        <div className='mt-[38px]'>
            <div className="slider" data-reverse="true" style={{
                '--width': '200px',
                '--height': '100px',
                '--quantity': '12'} as React.CSSProperties}>
                <div className="list">
                    ...
                    <div className="item" style={{'--position': 7} as React.CSSProperties}><Image src={HM} alt=""  className='w-[80px] h-[40px] mt-[24px]'/></div>
                    <div className="item" style={{'--position': 8} as React.CSSProperties}><Image src={OBEY} alt=""  className='w-[100px] h-[60px] mt-[15px]'/></div>
                    <div className="item" style={{'--position': 9} as React.CSSProperties}><Image src={SHOPIFY} alt=""  className='w-[120px] h-[80px] mt-[5px]'/></div>
                    <div className="item" style={{'--position': 10} as React.CSSProperties}><Image src={LACTOSE} alt=""  className='w-[120px] h-[40px] mt-[25px]'/></div>
                    <div className="item" style={{'--position': 11} as React.CSSProperties}><Image src={LEVIS} alt=""  className='w-[80px] h-[40px] mt-[28px]'/></div>
                    <div className="item" style={{'--position': 12} as React.CSSProperties}><Image src={AMAZON} alt=""  className='w-[100px] h-[60px] mt-[22px]'/></div>
